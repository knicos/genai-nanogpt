...
import { getExactlyOneTensor } from '@tensorflow/tfjs-layers/dist/utils/types_utils';
...
export class PositionEmbedding extends Layer {
    ...
    override call(inputs: Tensor | Tensor[], kwargs: PositionEmbeddingOptions): Tensor {
        return tidy(() => {
            ...
            const positionEmbeddings = this.positionEmbeddings
                .read()
                .slice([kwargs.startIndex, 0], [sequenceLength, featureLength]);
